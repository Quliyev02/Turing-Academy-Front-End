...
console.log(`Newer Car: ${newerCar.getDetails()}`); // Outputs: Newer Car: Red Honda Civic, Year: 2021

const newerSportsCar = Car.compare(sportsCar1, sportsCar2);
console.log(`Newer Sports Car: ${newerSportsCar.getDetails()}`); // Outputs: Newer Sports Car: Yellow Ferrari 488 GTB, Year: 2022

// Test comparison of a sports car with a regular car
const newerCarMixed = Car.compare(sportsCar1, car1);
console.log(`Newer Mixed Car: ${newerCarMixed.getDetails()}`); // Outputs: Newer Mixed Car: Blue Toyota Camry, Year: 2020
